...
export default function FormRutinas({
  ...
  const validateStep = () => {
    ...
    if (activeStep === 1) return formData.goal;
    if (activeStep === 2) return formData.bodyType;
    if (activeStep === 3) return formData.trainingDays && formData.sessionTime;
    if (activeStep === 4) return formData.experience;
    if (activeStep === 5) {
      if (formData.hasCondition === "Sí") return formData.conditionDetails;
  ...
  const handleDownload = () => {
    ...
    setActiveStep(7);
    setTimeout(() => {
      // Reset form al volver al inicio
    ...
    <div className="max-w-4xl mx-auto px-6 py-8 bg-white rounded shadow-md min-h-[500px] relative overflow-hidden">
      ...
      <form onSubmit={handleGenerate} className="space-y-8">
        ...
        {activeStep === 2 && (
          ...
          >
            <Option value="Ectomorfo">Ectomorfo (delgado por naturaleza)</Option>
        ...
        {activeStep === 7 && (
          ...
          >
            ...
            >
              {/* WebM optimizado */}
              <source src="/videos/perro-animacion.webm" type="video/webm" />
              {/* MP4 fallback */}
